...
<?php foreach ($Restaurant as $name): ?>
    <h5 class="" style="margin-bottom: -1rem; padding-top: 35px; padding-left: 40px;">
        ...
        <span style="color: blue;">/</span> 
        <a href="restaurants_city.php?cluster=<?= $cluster; ?>" style="text-decoration: none;"><?= $clusterName; ?> </a>
        <span style="color: blue;">/</span> 
        <a href="restaurants_categories.php?cluster=<?= $cluster;?>&categoria=<?= $categoria; ?>" style="text-decoration: none;"><?= $categoria; ?></a>
        <span style="color: blue;">/</span> 
        <?= $name['name'];?>
    </h5>
<?php endforeach; ?>
