<?php $title_name='Зарегистрироваться'; ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-4 shadow-lg">
      <div class="modal-header p-5 pb-4 border-bottom-0">
        <h1 class="fw-bold mb-0 fs-2 text-center">Зарегистрироваться бесплатно</h1>
      ...
      <div class="modal-body p-5 pt-0">
        <form class="">
          ...
          <small class="text-body-secondary">Нажав "Зарегистрироваться", вы соглашаетесь с условиями использования.</small>
          <hr class="my-4">
          <h2 class="fs-5 fw-bold mb-3">Или регистрация с помощью:</h2>
